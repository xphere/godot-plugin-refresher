...
func _enter_tree() -> void:
	...
	refresher.icon = get_editor_interface().get_base_control().get_theme_icon("Reload", "EditorIcons")
...
func _reload_plugins_list() -> void:
	...
	for display_name in origins:
		var plugin_names : Array = origins[display_name]
...
func refresh_plugin(p_name) -> void:
